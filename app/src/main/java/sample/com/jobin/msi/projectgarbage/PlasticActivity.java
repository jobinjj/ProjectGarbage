...
public class PlasticActivity extends AppCompatActivity {
    ...
    private void getData() {
        if (networkInfo == null){
            ...
            JsonArrayRequest request = new JsonArrayRequest(url + "email=" + email + "&category=" + "plastic",
    ...
    public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MyViewHolder> {
        ...
        public MoviesAdapter(ArrayList<Data> moviesList) {
...
//            holder.e_street.setText(movie.getE_street());
            ...
            holder.more.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(PlasticActivity.this,DetailActivity.class);
